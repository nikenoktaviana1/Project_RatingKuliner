  ...
  -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="sentimen1.html">
                      ...
                      <div  class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method='POST' action='proseskuliner.php'>
                            ...
                            <div class="form-group">
                              <label class="control-label" for="kordinat">Kordinat</label>
                ...
                <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        include 'koneksi.php';
                        $no = 1;
                        $sqltampil = mysqli_query($connect, "select * from tempatkuliner");
