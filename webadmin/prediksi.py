...
# str_tokenizing = "["
# for i in range(len(hasil_tokenizing[0])):
#   if i !=(len(hasil_tokenizing[0])-1):
#     str_tokenizing = str_tokenizing + "'" + hasil_tokenizing[0][i] + "', "
#   else:
#     str_tokenizing = str_tokenizing + "'" + hasil_tokenizing[0][i] + "'"
# str_tokenizing = str_tokenizing + "]"  
# str_tokenizing = [str_tokenizing]
...
hasil = {
  ...
  'remove_whitespace': hasil_remove_whitespace,
  ...
  'probabilitas_pembulatan': probabilitas_pembulatan,
