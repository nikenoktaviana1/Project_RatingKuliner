        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-header card-header-primary">
              <h3 class="card-title">Prediksi Dataset</h3>
            </div>
              <p></p>
              <p></p>
              <p></p>
                <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        include 'koneksi.php';
                        $no = 1;
                        $sqltampil = mysqli_query($connect, "select * from training");
                        while ($b=mysqli_fetch_array($sqltampil)) { ?>
                        <tr>
                          <td> <?php echo $no++ ;?></td>
                          <td> <?php echo $b['id_temkul'] ;?></td>
                          <td> <?php echo $b['steming'] ;?></td>
                          <td> <?php echo $b['labelsvm'] ;?></td>
                          <td> <?php echo $b['labelnbc'] ;?></td>
                          <td> <?php echo $b['kategorisvm'] ;?></td>
                          <td> <?php echo $b['kategorinbc'] ;?></td>
                        </tr>
                        <?php } ?>  
                      </tbody>
                    </table>
